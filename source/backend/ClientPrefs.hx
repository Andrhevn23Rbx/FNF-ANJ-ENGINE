...
@:structInit class SaveVariables {
	...
	public var optimizedSettings:Bool = false;
	public var comboPopup:Bool = true;
	public var comboRatingPopup:Bool = true;
	public var comboNumPopup:Bool = true;
	public var garbageCollect:Bool = false;
	public var notePooling:Bool = false;
	public var noteRecycling:Bool = false;
	public var noBotplayLag:Bool = false;
}
